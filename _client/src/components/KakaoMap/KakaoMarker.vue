  ...
  (newMap) => {
    ...
    const newMarker = new window.kakao.maps.Marker({
      ...
      image: new window.kakao.maps.MarkerImage(
        props.image.src,
        new window.kakao.maps.Size(props.image.size.width, props.image.size.height),
        {
          offset: new window.kakao.maps.Point(props.image.size.width, props.image.size.height),
        }
      ),
