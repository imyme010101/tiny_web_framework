...
onMounted(() => {
  ...
  markers.value.push(NaverMapHelper.setMarkerPosition(map, 2, {lat: 37.39964107585713, lng: 126.97383494039487}, {width: 70, height: 70}, '#FFB000', null, {name: '나', color: '#fff'}));
